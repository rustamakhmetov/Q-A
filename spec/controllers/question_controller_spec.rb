  ...
  describe 'PATCH #accept' do
    ...
    describe 'by Author question' do
      ...
      it 'assigns the requested params' do
        patch :accept, id: question, answer_id: answer1, format: :js
        expect(assigns(:question)).to eq question
      ...
      it 'accept answer' do
        ...
        patch :accept, id: question, answer_id: answer1.id, format: :js
        answer1.reload
        answer2.reload
      ...
      it 'change accept answer' do
        ...
        expect(answer2.accept).to eq false
        patch :accept, id: question, answer_id: answer1, format: :js
        patch :accept, id: question, answer_id: answer2, format: :js
        answer1.reload
        answer2.reload
        expect(answer1.accept).to eq false
